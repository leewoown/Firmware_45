...
// Checkin $Date: January 4, 2011   10:02:00 $ 
//###########################################################################
//
// FILE:   Example_F2806xClaAdcFirFlash.c
//
//
...
//
//   For 80 MHz devices (default) (assuming a 10Mhz input clock).
//
...
//
    ...
    EALLOW;
    GpioCtrlRegs.GPBDIR.bit.GPIO34 = 1;	  // GPIO34 is an output
	GpioDataRegs.GPBSET.bit.GPIO34 = 1;	  // GPIO34 pin is set to 1 
	GpioCtrlRegs.GPADIR.bit.GPIO18 = 1;	  // GPIO19 is an output
